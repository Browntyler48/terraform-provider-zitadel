...
func (r *passwordResetMessageTextResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	_, err = client.SetCustomPasswordResetMessageText(helper.CtxSetOrgID(ctx, orgID), zReq)
	if err != nil {
...
func (r *passwordResetMessageTextResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err = client.ResetCustomPasswordResetMessageTextToDefault(helper.CtxSetOrgID(ctx, orgID), &management.ResetCustomPasswordResetMessageTextToDefaultRequest{Language: language})
	if err != nil {
