...
func (r *verifyEmailOTPMessageTextResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	zReq := &management.SetCustomVerifyEmailOTPMessageTextRequest{}
	...
	_, err = client.SetCustomVerifyEmailOTPMessageText(helper.CtxSetOrgID(ctx, orgID), zReq)
	if err != nil {
...
func (r *verifyEmailOTPMessageTextResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err = client.ResetCustomVerifyEmailOTPMessageTextToDefault(helper.CtxSetOrgID(ctx, orgID), &management.ResetCustomVerifyEmailOTPMessageTextToDefaultRequest{Language: language})
	if err != nil {
