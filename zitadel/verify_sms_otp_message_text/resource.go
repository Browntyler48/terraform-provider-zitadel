...
func (r *verifySMSOTPMessageTextResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	zReq := &management.SetCustomVerifySMSOTPMessageTextRequest{}
	...
	_, err = client.SetCustomVerifySMSOTPMessageText(helper.CtxSetOrgID(ctx, orgID), zReq)
	if err != nil {
...
func (r *verifySMSOTPMessageTextResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err = client.ResetCustomVerifySMSOTPMessageTextToDefault(helper.CtxSetOrgID(ctx, orgID), &management.ResetCustomVerifySMSOTPMessageTextToDefaultRequest{Language: language})
	if err != nil {
